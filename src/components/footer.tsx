...
export default function Footer() {
  return (
    <footer className="bg-darkbg text-primary-foreground">
      <div className="container py-12">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-3 flex flex-col items-start space-y-4">
            ...
            <div className="flex space-x-1">
              <Button variant="ghost" size="icon" asChild className="text-primary-foreground hover:bg-primary-foreground hover:text-darkbg">
          ...
          <div className="md:col-span-5 grid grid-cols-1 sm:grid-cols-2 gap-8">
            <div>
                 ...
                 <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                        ...
                        <span className="text-sm text-primary-foreground/90"> Shop No. - 15,Ace Aspire, Plot No. - GH-02A, Sector - Techzone-4, Greater Noida, U.P., India - 201306</span>
                    </li>
                    <li className="flex items-start gap-3">
            ...
            <div>
                 ...
                 <div className="aspect-video rounded-lg overflow-hidden">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3503.3868168554022!2d77.42714067528745!3d28.588170275688896!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce569d1911353%3A0xac9ea884cd40d2e1!2sACE%20ASPIRE!5e0!3m2!1sen!2sin!4v1761681416423!5m2!1sen!2sin"
                        width="100%"
                        height="100%"
                        style={{ border: 0 }}
        ...
        <div className="mt-12 border-t border-primary-foreground/20 pt-8 flex flex-col md:flex-row justify-center items-center text-sm text-primary-foreground/80">

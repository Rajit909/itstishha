...
export default function TopNav() {
  return (
    <div className="bg-[#dceeef] text-primary-foreground">
      <div className="container flex h-8 items-center justify-between text-sm">
        <div className="flex items-center gap-6">
          ...
          <a href="mailto:contact@tishha.com" className="hidden md:flex items-center gap-2 text-darkbg hover:underline">
            <Mail className="h-4 w-4" />
            <span>contact@tishha.com</span>
          </a>
        </div>
        <div className="flex items-center gap-1">
            <Button variant="ghost" size="icon" asChild className="h-7 w-7 text-darkbg hover:bg-primary/80 hover:text-white">

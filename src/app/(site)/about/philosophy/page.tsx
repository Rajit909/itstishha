      ...
      <section className="py-16 md:py-24 bg-lightbluebg">
        <div className="container">
          <div className="grid md:grid-cols-3 gap-10 text-center">
            <div className="p-8 border rounded-lg shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 animate-fade-in-up bg-card" style={{ animationDelay: '200ms' }}>
            ...
            <div className="p-8 border rounded-lg shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 animate-fade-in-up bg-card" style={{ animationDelay: '400ms' }}>
            ...
            <div className="p-8 border rounded-lg shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 animate-fade-in-up bg-card" style={{ animationDelay: '600ms' }}>
